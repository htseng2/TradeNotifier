...
def predict_labels_with_threshold(gbm, X, threshold=0.3):
    """Predict labels using the LightGBM model with a custom threshold."""
...
def main():
    ...
    # Predict on the test set 0.5 threshold
    y_pred, y_prob = predict_labels_with_threshold(gbm, X_test, threshold=0.115)
